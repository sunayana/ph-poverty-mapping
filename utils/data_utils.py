...
def gaussian_mixture_model(
    ...
    """
    series = np.array(data[ntl_col]).reshape(-1,
                                             1)  # Reshape used to create a single column since data has a single feature.

    # Instantiate GMM
    # Attempts to find a mixture of Gaussian probability distributions that best models the pixel intensities.
    gmm = GaussianMixture(
